...
/***/ function(module, exports) {
	...
	module.exports = "\n<ul>\n  <li v-link=\"{name : 'home'}\">home</li>\n  <li v-link=\"{name : 'button'}\">button</li>\n  <li v-link=\"{name : 'weather'}\">weather</li>\n</ul>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/vue/button.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/vue/weather.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./weather.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./weather.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	  ...
	  methods: {
	    getData: function getData() {
	      ...
	      this.$http.get(this.apiURL).then(function (response) {
	        _this.$set('data', response.body['HeWeather data service 3.0'][0]);
	        _this.$set('weather', _this.data.now.cond.txt);
	        _this.$set('temp', _this.data.now.tmp);
	      });
	    }
	  }
	};
